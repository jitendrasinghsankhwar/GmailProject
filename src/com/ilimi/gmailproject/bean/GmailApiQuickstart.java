...
public class GmailApiQuickstart {
	...
	private static final String APP_NAME = "GmaiiApi ";
	// Email address of the user, or "me" can be used to represent the currently authorized user.
	private static final String USER = "jitendrasinghsankhwar@gmail.com";
	...
	public static void main(String[] args) throws IOException {
		...
		String url = flow.newAuthorizationUrl().setRedirectUri("http://dev.ilimi.in:8080/redirectUri").build();
		...
		GoogleTokenResponse response = flow.newTokenRequest(code).setRedirectUri("http://dev.ilimi.in:8080/redirectUri").execute();
		GoogleCredential credential = new GoogleCredential().setFromTokenResponse(response);
		
//		String s = credential.getAccessToken();
//		
//		System.out.println(s);
		...
		service.users().getProfile(USER).toString();
		...
		for (Thread thread : threads) {
			System.out.println("Thread ID: " + thread.getSnippet() + "::" + i++ + service.users().getProfile(USER).toString());
